...
Harassment = Offense.create(crime: "Harassment", picture: "http://caimages.co.uk/listing_images/F97X449_BL.jpg", description: "Bothering people, dogs, squirels... basically dog-jerks.")
